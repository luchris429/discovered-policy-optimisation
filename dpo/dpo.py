...
def compute_ppo_loss(
    ...
    drift = drift_func(target_action_log_probs, behaviour_action_log_probs, advantages, ppo_epsilon)
    ...
    clipfrac = (jnp.abs(rho_s - 1.0) > ppo_epsilon).mean()
...
def train(
    ...
    def update_model(carry, data):
        ...
        loss_grad = jax.tree_map(lambda x: jnp.nan_to_num(x), loss_grad)
